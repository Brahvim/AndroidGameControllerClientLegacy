...
public class EasingFunction {
     ...
     *
     * @apiNote `false` by default. Call `.start()` to make the function's processing active!
     */
     ...
     * (which many then be processed using {@linkplain EasingFunction::apply(Float[] p_parameters)},
     * to determine if the function can end. <b>The first parameter is the amount of time the
    ...
    public EasingFunction(Sketch p_parentSketch, Function p_function) {
